...
{ 
    public class Randomizer
    {
        ...
        {
            foreach (string file in System.IO.Directory.GetFiles("./Randomizer/Glitched World/Checks/", "*",SearchOption.AllDirectories))
            {
        ...
        {
            foreach (string file in System.IO.Directory.GetFiles("./Randomizer/Glitched World/Rooms/", "*", SearchOption.AllDirectories))
            {
                string contents = File.ReadAllText(file);
                string fileName = Path.GetFileNameWithoutExtension(file);
